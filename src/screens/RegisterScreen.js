        ...
        >
          <View className="flex-1 justify-center px-8 py-12">
            ...
            <View className="items-center mb-10">
              <View className="w-20 h-20 rounded-3xl items-center justify-center mb-4 shadow-lg" style={{ backgroundColor: '#2563EB' }}>
              ...
              <Text className="text-gray-500 text-center text-base">
                Join to start professional inspections
              </Text>
            </View>
            ...
            <View className="mb-6">
              ...
              <View
                className={`bg-white rounded-2xl px-4 py-4 shadow-sm ${
                  focusedField === 'confirmPassword' ? 'border-2 border-blue-500' : 'border border-gray-200'
                }`}
              >
                <TextInput
                  className="text-base text-gray-900"
